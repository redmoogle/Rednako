...
def commands():
    ...
    return render_template("commands.html", getsource=inspect.getsource, bot=bot, command_prefix=command_prefix, enabled_commands=cmddata, disabled_commands=disabled_commands, keys=keys)
